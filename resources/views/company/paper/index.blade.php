			...
			<td>
			     <td>
                                            ...
                                            @if($item->reviews->where("user_id","=",Auth::user()->id)->isEmpty())
                                             <a href="{{ url('/company/review/create?paper_id='. $item->id) }}" title="Add Review">
                                            ...
                                            <a href="{{ url('/company/review/' . $currentpaperreview->id) }}" title="View Review"><button class="btn btn-info btn-xs"><i class="fa fa-eye" aria-hidden="true"></i> View Review</button></a>
                                            @endif
