...
class ReviewController extends Controller
{
    ...
    return view('judge.review.index', compact('userpapers'));
    }
    ...
    return view('judge.review.create', compact('userpapers','paper_id'));
    }
    ...
    return view('judge.review.show', compact('review','page_title'));
    }
    ...
    return view('judge.review.edit', compact('userpaper'));
    }
