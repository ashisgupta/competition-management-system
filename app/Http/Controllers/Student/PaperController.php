...
class PaperController extends Controller
{
    ...
    {
        $userpapers = Paper::where("user_id", Auth::user()->id)->get();//dd($userpapers);
    return view('student.paper.index', compact('userpapers'));
    }
    ...
    return view('student.paper.show', compact('userpaper'));
    }
